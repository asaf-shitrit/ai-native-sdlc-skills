...
The approach this repository implements — running software work as a chain of committed artifacts, with the agent verifying itself and human judgment concentrated at the gates — is described in Anthropic's **[The AI-Native SDLC playbook](https://claude.com/blog/the-ai-native-sdlc-playbook)** by Louis Claxton (August 2026). That article is the origin of the ideas here and the canonical treatment of them. Read it.

This repository is an unofficial, independent implementation of that approach as [Claude Code skills](https://code.claude.com/docs/en/skills), so the guidance loads at the moment it applies rather than sitting in a browser tab. It is **not affiliated with, endorsed by, or reviewed by Anthropic**.
